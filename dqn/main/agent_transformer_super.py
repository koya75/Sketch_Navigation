...
from models.cnn_model import CNN_SKT_model
...
class Agent:
    def __init__(self, args):
        ...
        self.args.save_direct = self.args.save_direct + "SKT_super"
        ...
        if self.args.load_dir is None:
            ...
            log_f_name = self.args.save_direct + '/SKT_super'
        ...
        self.TTQ = CNN_SKT_model(obs_shape=args.obs_shape, n_actions=args.action_size, device=self.device).to(self.device)
        pretrain_dir = "results/DQN/Vanilla/pretrain/" + str(args.super_model) + "/models/best_model.pt"
        ...
        for epoch in range(self.args.n_epochs):
            ...
            for _ in range(self.n_cycles):
                ...
                for _ in range(self.args.n_updates):
                    ...
                    print('\r'+'['+str(time_taken)+'] SKT_super:' + str(self.run_num) + \
