...
class Agent:
    def __init__(self, args):
        ...
        self.args.save_direct = self.args.save_direct + "Vanilla/"
        ...
        if self.args.load_dir is None:
            ...
            log_f_name = self.args.save_direct + '/DQN'
            # logging file
        ...
        self.Q = CNN_SKT_model(obs_shape=args.obs_shape, n_actions=args.action_size, device=self.device).to(self.device)
        self.Q_target = CNN_SKT_model(obs_shape=args.obs_shape, n_actions=args.action_size, device=self.device).to(self.device)
        ...
        for epoch in range(self.args.n_epochs):
            ...
            for _ in range(self.n_cycles):
                ...
                for _ in range(self.args.n_updates):
                    ...
                    print('\r'+'['+str(time_taken)+'] Vanilla:' + str(self.run_num) + \
