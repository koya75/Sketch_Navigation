...
class Agent:
    def __init__(self, args):
        ...
        self.args.save_direct = self.args.save_direct + "Vanilla_nopos/"
        ...
        if self.args.load_dir is None:
            ...
            log_f_name = self.args.save_direct + '/DQN_nopos'
            # logging file
        ...
        self.Q = CNN_SKT__nopos_model(obs_shape=args.obs_shape, n_actions=args.action_size, device=self.device).to(self.device)
        self.Q_target = CNN_SKT__nopos_model(obs_shape=args.obs_shape, n_actions=args.action_size, device=self.device).to(self.device)
        ...
        for epoch in range(self.args.n_epochs):
            ...
            for _ in range(self.n_cycles):
                ...
                for _ in range(self.args.n_updates):
                    ...
                    print('\r'+'['+str(time_taken)+'] Vanilla_nopos:' + str(self.run_num) + \
