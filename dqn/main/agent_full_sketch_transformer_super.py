...
class Agent:
    def __init__(self, args):
        ...
        self.args.save_direct = self.args.save_direct + "SKT_full_super"
        ...
        if self.args.load_dir is None:
            ...
            log_f_name = self.args.save_direct + '/SKT_full_super'
        ...
        for epoch in range(self.args.n_epochs):
            ...
            for _ in range(self.n_cycles):
                ...
                for _ in range(self.args.n_updates):
                    ...
                    print('\r'+'['+str(time_taken)+'] SKT_full_super:' + str(self.run_num) + \
